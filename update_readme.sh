...
KONG_PLUGINS_METADATA_ENDPOINT=${3:-http://172.17.0.1:7999}
...
docker run --rm leandrocarneiro/kong-plugin-schema-to-markdown:next ${PLUGIN_NAME} ${KONG_SCHEMA_ENDPOINT} ${KONG_PLUGINS_METADATA_ENDPOINT} >> README-B
